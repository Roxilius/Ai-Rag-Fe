...
const EditUserPopup: React.FC<EditUserPopupProps> = ({ isOpen, user, onClose, onSave }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold mb-4 text-gray-900">Edit User Role</h2>
        <div className="mb-3">
        ...
        <div className="flex justify-end mt-6 gap-3">
          ...
          <motion.button
            whileHover={{ scale: 1.08, boxShadow: "0 0 15px rgba(59,130,246,0.4)" }}
            whileTap={{ scale: 0.95 }}
            onClick={() => {
              if (selectedRole) {
